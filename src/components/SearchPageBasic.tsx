...
export default function SearchPageBasic() {
   ...
   return (
      <div className=" max-w-[92%] sm:max-w-[69%] mx-auto my-28">
         <Toaster
            position="top-center"
            toastOptions={{
               style: {
               ...
               <Card className="pb-6">
                  <CardHeader>
                     <CardTitle className="text-2xl font-bold flex items-center">
                        ...
                        <h1 className="text-xl md:text-2xl font-bold flex justify-between items-center">
                           {" "}
                           RecruitCatch - FREE XRay Search Tool for Linkedin
                        </h1>
                     </CardTitle>
                  </CardHeader>
                  <CardContent className="space-y-6">
                     ...
                     <div className="space-y-4">
                        ...
                        <Button
                           className="w-full bg-gradient-to-br from-purple-800  to-indigo-500  hover:from-indigo-500 hover:to-purple-500 text-white hover:bg-blue-700"
